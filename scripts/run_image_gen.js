...
const scriptPath = path.join(__dirname, 'generate_images.ps1');
fs.writeFileSync(scriptPath, Buffer.concat([bom, Buffer.from(psScript, 'utf8')]));

console.log('Saved generate_images.ps1 with UTF-8 BOM. Executing...');
